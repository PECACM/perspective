...
const NavigationBar = (props) => {
	...
	const sectionInViewProps = props.props;
	...
	const handleCloseDetails = (event) => {
		// console.log(sectionInViewProps);
			...
			<Toolbar disableGutters>
				...
				<Box sx={{flexGrow: 1, display: {xs: 'none', md: 'flex'}}}>
					<Button
						...
						variant={sectionInViewProps === "Home" ? "contained" : ""}
					><Link href="/" color="white" underline="hover">Home</Link></Button>
					<Button
						key="About"
						onClick={handleOpenAbout}
						sx={{my: 2, color: 'white', display: 'block'}}
						variant={sectionInViewProps === "About" ? "contained" : ""}
					...
					<Button
						...
						sx={{my: 2, color: 'white', display: 'block'}}
						variant={sectionInViewProps === "Committee" ? "contained" : ""}
					...
					<Button
						sx={{my: 2, color: 'white', display: 'block'}}
						variant={sectionInViewProps === "Papers" ? "contained" : ""}
					><Link href="#" color="white" underline="hover">Call For Papers</Link></Button>
					<Button
						key="Details"
						onClick={handleOpenDetails}
						sx={{my: 2, color: 'white', display: 'block'}}
						variant={sectionInViewProps === "Details" ? "contained" : ""}
					...
					<Button
						sx={{my: 2, color: 'white', display: 'block'}}
						variant={sectionInViewProps === "Contact" ? "contained" : ""}
					><Link href="#" color="white" underline="hover">Contact Us</Link></Button>
					
					<Button
						sx={{my: 2, color: 'white', display: 'block'}}
						variant={sectionInViewProps === "Login" ? "contained" : ""}
